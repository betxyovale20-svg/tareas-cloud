...
const SUPABASE_URL = 'https://kkbehfgvebtyowwjubhd.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtrYmVoZmd2ZWJ0eW93d2p1YmhkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE1MTYyNTksImV4cCI6MjA5NzA5MjI1OX0.C6wXRU2tWlSJJnoKNtBBJQM-hqp9zyLvLB2MF1CCguI';
...
function renderTareas(tareas) {
    ...
    if (tareas.length === 0) {
        cont.innerHTML =
            '<p class="vacio">No hay tareas aún.</p>';
        return;
    }
